...
def train_test_split_and_feature_extraction(df, test_size=0.3, random_state=42):
    ...
    train_df, test_df = train_test_split(df, test_size=test_size, random_state=random_state, stratify=df["class_id"])
    ...
    label_columns = ["class_id"]  # Assuming this is your label column
