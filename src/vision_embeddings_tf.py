...
class FoundationalCVModel:
    ...
    def __init__(self, backbone, mode='eval', input_shape=(224, 224, 3)):
        ...
        if backbone == 'resnet50':
            ...
            print("Cargando modelo ConvNeXtV2 Tiny")
            from transformers import TFConvNextV2Model
            model_id = "facebook/convnextv2-tiny-22k-224"
            self.base_model = TFConvNextV2Model.from_pretrained(model_id, token="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")
            ...
            self.base_model = TFViTModel.from_pretrained(model_id, token="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")
        ...
        if backbone in ['vit_base', 'vit_large', 'convnextv2_tiny', 'convnextv2_base', 'convnextv2_large', 'swin_tiny', 'swin_small', 'swin_base']:
            ...
            input_layer_transposed = tf.transpose(input_layer, perm=[0, 3, 1, 2])  # Channels-first
